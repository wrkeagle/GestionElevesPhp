...
@section('content')
    ...
    <div class="row mt-3">
        <div class="col-md-8">
            <div class="float-left">
                <h2>Ajouter nouvelle promotion</h2>
            </div>
        </div>
    ...
    @if ($errors->any())
        <div class="alert alert-danger">
            <strong>Whoops!</strong> Il y a des problemes avec ce que vous avez entré<br><br>
            <ul>
    ...
    <form action="{{ route('promos.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="address" name="specialite" placeholder="Spécialité"></textarea>
        </div>
